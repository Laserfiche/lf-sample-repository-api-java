...
public class Sample {
    ...
    public static CompletableFuture<String> getRepositoryName() {
        ...
        CompletableFuture<String> repositoryName = repositoryListResponse.supplyAsync(() ->
                repositoryListResponse.join().get(0).getRepoName());
        CompletableFuture<String> repositoryId = repositoryListResponse.supplyAsync(() ->
                repositoryListResponse.join().get(0).getRepoId());
